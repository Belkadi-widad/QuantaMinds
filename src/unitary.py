...
## calculate the total params for each Unitary 

Unitaries = [None, 'U_TTN', U_TTN, U_5, U_6, U_9, U_13, U_14, U_15, U_SO4, U_SU4]
U_num_params=  [0, 0, 2, 10, 10, 2, 6, 6, 4, 6, 15]
unitaries_params_dict = {k: v for k, v in zip(Unitaries, U_num_params)}
